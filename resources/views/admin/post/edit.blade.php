    ...
    <div class="row clearfix">
            ...
            <div class="card">
                ...
                <div class="body">       
                        ...
                        <div class="form-group">
                            <label for="image" >Image Features</label>
                            <input type="file" name="image">
                        </div>

                        <div class="form-group">
                            <input type="checkbox" class="filled-in" name="status" id="publish" value="1" {{ $post->status == true ? 'checked' : '' }} >
        ...
        <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">       
                        <div class="form-group form-float">
                            <div class="form-line {{ $errors->has('categories') ? 'focused eror' : ''}}">
